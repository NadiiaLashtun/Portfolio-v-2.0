...
function HeroPage() {
  return (
    <section className='relative py-8 sm:py-16 min-h-[calc(100vh-64px)] flex items-center'>
      <BackgroundText
        text='web'
        left='30%'
        top='-10%'
      ...
      />
      <Wrapper>
        <div className='flex flex-col items-center justify-center gap-5 sm:flex-row sm:gap-3'>
          ...
          >
            ...
            <img
              src={HeroImg}
              className='absolute left-[16%] md:left-[5%] -bottom-16 max-h-[110%]  z-10'
              alt='Main Photo'
            />
            <Arrow position='absolute -right-[10px] top-[10%] h-1/2' />
            {/* Square */}
            <div className='absolute left-1/2 -translate-x-1/2 -bottom-12 w-full lg:w-[80%] xl:w-[45%] h-[98%] -z-20 sm:z-0 md:h-[94%]'>
              <BackgroundSquare />
            </div>
            <div>
